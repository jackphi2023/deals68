...
export const ui = {
  vi: {
    ...
    admin: 'Quản trị',
    logout: 'Đăng xuất',
    searchBusinesses: 'Tìm doanh nghiệp',
    searchInvestors: 'Tìm nhà đầu tư',
    country: 'Quốc gia',
    industry: 'Lĩnh vực',
    dealType: 'Hình thức giao dịch',
    revenue: 'Doanh thu 2025',
    ebitda: 'EBITDA',
    businessQuality: 'Điểm chất lượng doanh nghiệp',
    dataConfidence: 'Độ tin cậy dữ liệu',
    view: 'Xem chi tiết',
    save: 'Lưu',
    expressInterest: 'Bày tỏ quan tâm',
    requestData: 'Yêu cầu tài liệu',
    sendProposal: 'Gửi đề xuất',
    onlyInvestorsQuality: 'Chỉ nhà đầu tư đã đăng nhập mới xem được chi tiết điểm chất lượng doanh nghiệp.',
    noMatchedBusinesses: 'Chưa có doanh nghiệp phù hợp hiện tại, hãy cập nhật sau.',
    hiddenContact: 'Thông tin liên hệ chỉ mở khi hai bên được duyệt kết nối.',
  },
  en: {
