...
export default function Admin() {
  ...
  async function approveBusiness(event: FormEvent, business: Row) {
    ...
    const adminSnapshot = {
      ...
      country_iso2: text(form.get('country_iso2')) || 'VN',
