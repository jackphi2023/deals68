...
const BUSINESS_FINANCIAL_REVIEW_FIELDS = [
  ...
  ['included_tangible_assets_vi', 'Tài sản hữu hình đưa vào giao dịch (VN)'],
    ...
    const adminSnapshot = {
      ...
      financial_input: {
        ...
        included_tangible_assets:
          text(form.get('included_tangible_assets_vi')) ||
          text(form.get('included_tangible_assets_en')),
