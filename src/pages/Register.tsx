...
export default function Register({ lang = 'vi' }: { lang?: Lang }) {
  ...
  async function submit(e: FormEvent) {
    ...
    try {
      ...
      setMsg(T(lang, 'Tài khoản và hồ sơ đã được tạo, đang chờ thanh toán/Admin duyệt trước khi hiển thị public.', 'Account/profile created and pending payment/Admin review before public listing.'));
      setTimeout(() => navigate(toLocalizedPath('/login', lang)), 1400);
