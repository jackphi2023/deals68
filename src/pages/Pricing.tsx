...
export default function Pricing({ lang }: { lang: Lang }) {
  ...
  return <main className="d68-pricing-page">
    <section className="d68-pricing-hero"><div><span>{T(lang, 'Bảng Giá Giải pháp Deals68', 'Deals68 Solution Pricing')}</span><h1>{T(lang, 'Bảng giá minh bạch, linh hoạt', 'Transparent, flexible pricing')}</h1><p>{T(lang, 'Doanh nghiệp trả phí hiển thị theo tuần; Nhà đầu tư Nâng cao và Cố vấn trả phí theo tháng. Kỳ hạn dài hơn — giảm giá nhiều hơn.', 'Businesses pay a weekly listing fee; Premium Investors and Advisors pay monthly. Longer terms mean bigger discounts.')}</p></div></section>
