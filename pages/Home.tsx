...
export default function Home({ lang }: { lang: Lang }) {
  ...
  const searchUrl = mode === 'business'
    ? buildPath(to('/businesses'), { search: keyword, industry, country, dealType })
    : buildPath(to('/investors'), { search: keyword, industry, country, type: investorType });
  ...
  const roleCards = [
    ...
    { badge: 'blue', icon: '💼', bg: '#E7F6FD', color: '#1596cc',
      ...
      cta: T(lang, 'Khám phá cơ hội', 'Explore opportunities'), to: to('/investors') },
    { badge: 'gold', icon: '🤝', bg: '#EAF7EF', color: '#16A34A',
      ...
      cta: T(lang, 'Trở thành đối tác', 'Become a partner'), to: to('/partners') }
  ];
  ...
  return (
    <main>
      ...
      <section className="d68-home-container d68-home-promo">
        <Link to={to('/pricing')}><img src={promoImg} alt={T(lang, 'Ưu đãi Beta Deals68', 'Deals68 Beta promotion')} loading="lazy" /></Link>
      </section>
      ...
      <section className="d68-home-container d68-home-section">
        <div className="d68-home-title d68-home-title--row">
          ...
          <Link to={to('/businesses')}>{T(lang, 'Xem tất cả', 'View all')} →</Link>
        </div>
        {loading
          ...
          : deals.length
            ? <div className="d68-home-deals">
              {deals.slice(0, 6).map((d) => (
                <Link key={d.id} to={to(`/businesses/${d.slug}`)} className="d68-home-business-card">
      ...
      <section className="d68-home-section d68-home-section--alt">
        <div className="d68-home-container">
          ...
          <div className="d68-home-industry-grid">
            {industries.map((it) => (
              <Link key={it.vi} to={to(`/businesses?industry=${encodeURIComponent(T(lang, it.vi, it.en))}`)} className="d68-home-industry-card">
      ...
      <section className="d68-home-container d68-home-valuation">
        <div className="d68-home-valuation__box">
          ...
          <Link to={to('/valuation')}>{T(lang, 'Định giá ngay', 'Value my business')} →</Link>
        </div>
      </section>
      ...
      <section className="d68-home-container d68-home-section">
        <div className="d68-home-title d68-home-title--row">
          ...
          <Link to={to('/investors')}>{T(lang, 'Xem tất cả', 'View all')} →</Link>
        </div>
        {loading
          ...
          : investors.length
            ? <div className="d68-home-investor-grid">
              {investors.map((i) => (
                <Link key={i.id || i.code} to={to(`/investors/${i.code}`)} className="d68-home-role-card" style={{ padding: 22 }}>
      ...
      <section className="d68-home-partner">
        <div className="d68-home-container">
          ...
          <Link to={to('/partners')}>{T(lang, 'Tìm hiểu chương trình đối tác', 'Explore the partner program')} →</Link>
        </div>
      </section>
    </main>
  );
