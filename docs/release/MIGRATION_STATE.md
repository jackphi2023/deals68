...
| 20260716070307 | `20260716190000_investor_public_profile_pending_v6.sql` |
...
Investor Workflow V14 database changes are backward compatible:
...
- All public profile and taxonomy changes submitted from Investor Dashboard are stored in `privacy.pending_profile_changes` until Admin approval.
- Internal name and private website remain editable immediately.
- Approved public profile and approved criteria remain unchanged while a pending version exists.
