...
component = "src/components/admin/InvestorAdminReviewPanel.tsx"
...
marker = "/* Admin Investor Plans Phase 4 */"
if marker not in css:
    css += """

/* Admin Investor Plans Phase 4 */
.d68-admin-investor-plan-stats{display:flex;align-items:center;justify-content:flex-end;gap:8px;flex-wrap:wrap}
.d68-admin-investor-plan-box{margin:0 0 18px;padding:16px;border:1px solid #F2D36B;border-radius:14px;background:#FFFBEB}
.d68-admin-investor-plan-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:14px}
.d68-admin-investor-plan-head>div{display:flex;min-width:0;flex-direction:column;gap:5px}
.d68-admin-investor-plan-head b{color:#0F2A4A}
.d68-admin-investor-plan-head>div>span{color:#64748B;font-size:12.5px;line-height:1.45}
.d68-admin-investor-plan-grid{display:grid;grid-template-columns:minmax(210px,1fr) minmax(160px,.8fr) minmax(180px,.8fr) minmax(240px,1.4fr);gap:12px;align-items:start}
.d68-admin-investor-plan-toggle{min-height:42px;padding:10px 12px;border:1px solid #E8C94F;border-radius:10px;background:#fff;color:#0F2A4A;font-weight:900}
.d68-admin-investor-plan-actions{align-items:center}
.d68-admin-investor-plan-actions .d68-admin-subtle{flex:1}
@media(max-width:1100px){.d68-admin-investor-plan-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media(max-width:700px){.d68-admin-investor-plan-grid{grid-template-columns:1fr}.d68-admin-investor-plan-head{flex-direction:column}.d68-admin-investor-plan-stats{justify-content:flex-start}}
"""
...
'''
Path("scripts/deals68-admin-investor-plans-phase4-check.mjs").write_text(qa)

replace_once(
    "package.json",
    '    "qa:investor-pricing": "node scripts/deals68-investor-pricing-phase3-check.mjs"\n',
    '    "qa:investor-pricing": "node scripts/deals68-investor-pricing-phase3-check.mjs",\n    "qa:admin-investor-plans": "node scripts/deals68-admin-investor-plans-phase4-check.mjs"\n',
)
